...
Today, there are hundreds of ecology journals representing subdisciplines spanning in scope from theoretical to applied and in scale from genomes to ecosystems.
...
In light of such rapid growth and diversification, synthesizing larger trends in a field can be challenging, yet broad overviews are critical for bridging subdisciplines.
