...
We compared the trends in the most commonly used terms from the 1940s and the 2000s using 1-grams and 2-grams (Fig. \@ref(fig:decades)a-d). We found that the most commonly used word (1-grams) in ecology is "species" and that has not changed over the last century (Fig. \@ref(fig:decades)a&c), and is still a word that continues to increase in use. The next two most commonly used words in ecology, *plant* and *area*, have also not changed from the 1930s to 2000s. The remaining most commonly used words from the 1940s have generally declined in use since the 1940s, while the remaining most commonly used words from the 2000s have increased over time. We saw a similar pattern with 2-grams from the 1940s where all of the words are in a state of decline (Fig. \@ref(fig:decades)b), whereas nearly every 2-gram for the 2000s has increased in use since the 1930s. By far, the terms that have the greatest popularity and increase in use are *climate* and *climate change* (Fig. \@ref(fig:decades)d-f). This reflects the recognized role humans play in earth's ecosystem processes in the last few decades as concern over climate change has increased, along with the need for conservation science (Fig. \@ref(fig:decades)e). Other terms also standout because of their conservation implications, such as *conservation*, *impact*, *biodiversity*, *ecosystem service*, *invasive species*, and *global ecology* (Fig. \@ref(fig:decades)e&f).

The changes we observed between popular terms from the 1940s and 2000s, likely relfect both a shift in science culture and are reflected in greater societal issues facing earth. In the 1940s popular terms, such as *time*, *number* and *day* (Fig. \@ref(fig:decades)a), reference descriptive data, probably more common before statistics and modelling became standard tools in ecological research. Similar terms that could represent time, day, and number are *data*, *effect*, *population*, and *model* (Fig. \@ref(fig:decades)b), which likely represents both replacement in terminology and a change in the field of ecology from a semi-quanitative to quantitiative discipline. Popular terms from the 1940s included *blue grama* and *wheatgrass* (Fig. \@ref(fig:decades)c), terms that could be considered rare today were important in the 1940s, likely due to famine in United State in the 1930s and World War II in the 1940s. Blue grama (*Bouteloua gracilis*) was heavily studied in the 1930s due to its drought tolerance (CITATION), whereas wheat grass research was likely intensified in the 1940s to feed troops fighting in World War II (CTIATION). This focus on agricultural research was supported by other popular 2-grams from the 1940s, such as *organic matter*, *soil moisture*, and *fresh water* (Fig. \@ref(fig:decades)c).
...
Fig. \@ref(fig:ecology)
From the onset, ecologists and conservation biologists have studied organisms at the species-level (3a). 
Though cell-level studies were initially the next most common, the interests within the field of ecology have been growing in scale of study with populations, followed by communiies and ecosystems (3b). 
Initially, abundance metrics were the most commonly reported, yet abundance and richness are currently on the decline as diversity indicies, which incorporate both abundance and richness, have become the most common since the mid-1990s (3c). 
The theory of the climax community climaxed in the 1940’s, and community structure and populations next peak occurred in the 1960’s with the Theory of Island Biogeography (cite), followed by an interest in foraging theory, and a peak and dropoff in neutral theory (cite) (3d). 
The theory of natural selection and the role of evolution in ecology has been a constant theme (3d). In ecology, the null hypothesis reigns, with a meteoric rise in the 1970’s, replacing the frequently mentioned hormone hypothesis (cite) in the 1930’s – 1950’s. 
Over time, competition, disturbance and competitive release hypothesis have been posed and studied as potential _______________ (3e). 
Finally, though competition out-competes other interactions, competition and predation are both declining in study, with mutualisms and parasitism remaining of constant interest to a lesser degree (3g).  
...
The focus on genetics in ecology and conversation related research has
skyrocketed in the past several decades. This can be seen in the massive
increase in the term *genetic diversity* (Fig. \@ref(fig:blanks)f and
\@ref(fig:methods)e). *Phylogenetics* remained the most common referenced
genetic term from 1930 to 2010, and increased in use rapidly since the 1990s
(Fig. \@ref(fig:methods)e). With the advent of *next-generation sequencing*, we
also see a fast increase in sequencing based approaches to studying genetic
diversity, particularly the rise in reference to *single nucleotide
polymorphisms* (Fig. \@ref(fig:methods)f). Interestingly, the term
*epigenetics* has been in use since the 1950s (see Supplementary Fig. TODO),
before we had methods for studying epigenetics in the modern sense [@bird2007].
This is likely because, beginning in the 1940s, *epigenetics* was used to refer
to the differentiation of cells during embryonic development [@waddington2012].
