...
- Pre-1990: (not sure, potentially ecolabelling of food and consumer products?)

  <!-- Diogo: I think that in this case the fact that not much is happening is the main finding,
  although given the word limits I think we should such ignore it. -->

- The 1992 Rio Summit spurned a plethora of conservation initiatives across the globe
  (ref), and subsequent research on the need for and effects of these interventions.  One
  of these interventions was the Forest Stewardship Council, a certification scheme
  initiated in 1993 in response to perceived inaction from the Rio Summit (FSC 2019,
  https://us.fsc.org/en-us/who-we-are/our-history). Since then certification schemes have
  expanded considerably,  with two environmental certification schemes (Rainforest
  Alliance, Marine Stewardship Council) alone account for 10%, 20%, and 14% of the world's
  cocoa, tea, and wild marine catch production (ref). This exponential increase in
  coverage is the likely driver of research on these types of interventions after the
  1990s.
- Reducing Emissions from Deforestation and forest Degradation (REDD) initiatives was
  launched in 2005 (ref, un-redd.org)
- Ecotourism also took off in the 1980 and 90s, where it was included in the development
  strategy of almost every developing country by the 1990s [@moreno2005]

Human wellbeing
<!-- Diogo: One way to frame the strands would be around planetary health, which nicely
bridges conservation and human health -->

- Most of the research on human wellbeing in the corpus centers on poverty
- The feedbacks between poverty and biodiversity loss are well known, along with some of
  the negative effects of  biodiversity conservation efforts on human wellbeing  (ref) The
  Millenium Development Goals and the Convention on Biological Diversity (1990s) advanced
  research and action on the concept of ecosystem services (now reframed as nature's
  contribution to people (ref)), where there was growing interest in how environmental
  improvement can promote (and not harm) human wellbeing, often through poverty
  alleviation (ref). Of the various aspects of human wellbeing, indicators related to
  economic well being (e.g.  poverty, income, material living standards) are the most
  studied (ref)
- Recent interest in food security is likely closely linked to poverty alleviation, and
  the impacts of environmental change to food availability?
