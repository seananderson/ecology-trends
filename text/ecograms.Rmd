...
Our results also highlight that the analytical techniques used in ecology have evolved with ecological research becoming increasingly quantitative and data-driven (Fig. \@ref(fig:methods)). In particular, many statistical paradigms and genetic analytical techniques have emerged in the ecological literature over the past three decades, despite being already applied in other disciplines, such as computer science and engineering. This indicates that advanced training in statistics, genetic techniques, and computer programming is important in ecological curricula. Furthermore, ecological statistical curricula need to transition from recipe-based approaches involving ANOVAs and t-tests to curricula that emphasize probability theory, programming, and simulation-based approaches [@mcelreath2015] if students are to be prepared for the research published in the field (Fig. \@ref(fig:methods)a--b).
...
<!-- went through NEE and there wasn't much there in terms of things to cite: here are some suggested articles:
Sandbrook C, JA Fisher, G Holmes, R Luque-Lora, A Keane. 2019. The global conservation movement is diverse but not divided. 
Anton et al. 2019. Global ecological impacts of marine exotic species.
