...
Terms related to TeX that appeared in some American Naturalist papers that we removed: `r bad_amnat`.

- how many papers in end, how many words

- Standardized per total number of 1-grams each year
- List this in the supplement: Pnas_exluded_pub_ids.rds: 112,259
...
# TODO: need to fix the latex preamble so this will render:
journals %>% 
  knitr::kable() %>% 
  kableExtra::column_spec(column = 1, width = "3in")
```
