...
(ref:fig-ecology-cap) **Community ecology n-grams from 1930--2010.** Panel **b** is the same as panel **a**, but removes the 1-gram *species* to better visualize the remaining terms. Panels **e** and **f** are based on the same algorithm used in Fig. \@ref(fig:blanks) to find the top eight n-grams for "theory of *blank*" or "*blank* theory" and "*blank* hypothesis".
