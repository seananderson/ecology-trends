...
subdisciplines, the field spans in scope from general to applied to
...
conservation themes (see Methods). Our approach therefore enables data-derived comparisons
of trends in ecology and conservation to yield insights into the evolution
...
We found that the most commonly used word (1-gram) in ecology is *species* and that has not changed over the last eighty years with *species* continuing to increase in use (Fig. \@ref(fig:decades)a,c).
The next two most commonly terms words in ecology, *plant* and *area*, have also not changed from the 1930s to 2000s.
The remaining most commonly used terms from the 1940s have generally declined in use since the 1940s, while all the most commonly used terms in the 2000s have increased in use over time.
We saw a similar pattern with popular 2-grams from the 1940s where all such 2-grams are in a state of decline (Fig. \@ref(fig:decades)b), whereas every popular 2-gram in the 2000s has increased in use since the 1930s.
...
By far, the 1- and 2-grams that have had the greatest rise in use over time are *climate* and *climate change* (Fig. \@ref(fig:decades)d--f).
This reflects the recognized role humans play in earth's ecosystem processes in the last few decades as concern over climate change has increased alongside the growth of conservation science [@scheffers2016] (Fig. \@ref(fig:decades)e).
...
Similar terms that could represent time, day, and number are *data*, *effect*, *population*, and *model* (Fig. \@ref(fig:decades)c), which likely represents both a replacement of terminology and an underlying change in ecology from a semi-quantitative to quantitative discipline.
Popular terms in the 1940s included *blue grama* (*Bouteloua gracilis*) and *wheatgrass* (Fig. \@ref(fig:decades)c), which are rarely used today but were of greater significance in the 1940s, likely due to famine in the United States in the 1930s and World War II in the 1940s.
For example, blue grama was heavily studied in the 1930s due to its drought tolerance (CITATION), whereas wheat grass research likely intensified in the 1940s to feed troops fighting in World War II (CITATION).
...
Ecologists have written about *community structure*, and *community composition* more than any other adjective-form of *community* and about *plant communities*, within our corpus, over three times more often (FIXME: check) than any other form of community (Fig. \@ref(fig:blanks)gh).
...
Though references to *cell*ular level were initially the next-most common, interest within the field of ecology has since transition to *populations*, followed by *communities* and *ecosystems* (Fig. \@ref(fig:ecology)b).
*Competition* and *predation* are the interactions most commonly included in the corpus, yet both interactions are experiencing sharp relative declines since the 1980's and early 2000's, respectively (Fig. \@ref(fig:ecology)c). 
Interestingly, the most commonly represented theories in ecology all appear to be in declining use (Fig. \@ref(fig:ecology)d). For example, the theory of the *climax community* climaxed in the 1940s, followed by the peak for the *theory of island* biogeography in the late 1970's, early 1980's, and a peak and dropoff in *neutral theory* in the mid-2000's as each was posed to help explain community structure and diversity patterns (REF) (Fig. \@ref(fig:ecology)d).
Though we do not observe correlations between the rise and fall of the most common theories and the most common hypotheses, the decline in the mention of *competition* (Fig. \@ref(fig:ecology)c)is mirrored by the decline in interest in the competition hypothesis (Fig. \@ref(fig:ecology)e), which as terms in the corpus may be inextricably intertwined in this context. 
Overall, while metrics of *abundance* were initially the most commonly reported (Fig. \@ref(fig:ecology)c).
they plateaued in the 2000s while references to *diversity*, which incorporates both *abundance* and *richness*, have become the most common since the mid 1990s (Fig. \@ref(fig:ecology)c).
...
the corpus in 1994 [@thompson1994], 24 years after Hastings[@hastings1970] described the
...
To that end, use of the phrase *null hypothesis* peaked in the
...
The focus on genetics in ecology and conversation related research has skyrocketed in the past several decades. This can be seen in the increase in the use of the term *genetic diversity* (Fig. \@ref(fig:blanks)f and \@ref(fig:methods)e).
*Phylogenetics* remained the most commonly referenced genetic term from 1930 to 2010, and increased in use rapidly since the 1990s (Fig. \@ref(fig:methods)e).
With the advent of *next-generation sequencing* (ADD REF?), we also see an increase in sequencing-based approaches to studying genetic diversity, particularly the rise in references to *single nucleotide polymorphisms* (Fig. \@ref(fig:methods)f).
Notably, the term *epigenetics* has been in use since the 1950s (Supplementary Fig. \@ref(fig:methods-all)), before ecologists even had methods for studying epigenetics in the modern sense [@bird2007].
...
various stakeholders and local communities (Fig. \@ref(fig:social)d). 
<!-- FIXME: I like the following sentence but I wonder if it's sticking our neck a bit out beyond our specific results to include it in this paper... maybe modify it slightly? -->
Yet, it is
...
(Table \@ref(tab:included-journals), Fig. TODO).
...
'year' refers to a respective year, and '$\mathrm{total}_i$', which acts as an offset term,
refers to the total number of 1-grams in year $i$. We sorted the n-grams by their $\beta_1$
