...
urlcolor: "blue"
abstract: >
  The field of ecology and conservation has evoloved rapidly over the last century.
  Synthesizing that growth into a broad overview of the field remains a challenge and yet is critical to bridging subdisciplines, guiding research directions, and informing educational frameworks.
  Here we provide the largest full-text culturomic analysis of ecology and conservation journals to date covering eight decades, 52 journals, and half a billion words.
  Our analysis illustrates overall trends in ecological term usage and trends within the themes of conservation, general and community ecology, statistical and genetic ecology, and the social sciences.
  We track the evolution of ecology from a largely descriptive field focused on natural history and observational field studies to a more data-driven multidisciplinary field focused on applied environmental problems.
  We highlight the boom and bust of ecological hypotheses and theories; the adoption of statistical, genetic, and social science approaches; and the domination of terms as of 2010 that emerged only after 1990 (e.g., climate change, invasive species, ecosystem services, meta-analysis).
  Overall, our analysis highlights the increasing breadth of the field, illustrating that there is room for more types of ecologists today than ever before.
---


<!--
  Left over abstract text:

  Opinion- and survey-based approaches can form a biased perspective of the field and data-driven approaches have tended to focus on specific journals, subdisciplines, or title and abstract databases.

  theory as terms representing new ideas emerge and all terms are replaced with new ones with slightly different focuses

  the emergence of supplementary material and the death of unpublished data and personal communications

  Terms representing new ideas emerge, and old terms

  notable results include the evolution of ecology and conservation into more quantitative and data-driven disciplines; the domination of terms as of 2010 that did not emerge until after 1990 (e.g., climate change, biodiversity, invasive species, ecosystem services, and meta-analysis), the emergence of supplementary material and the death of unpublished data and personal communications, and the frequent boom and bust of ecological hypotheses and theories.

  we delve into the evolution of ecology and conservation.

  increasingly specialized topics at broader spatial scales.

  The ubiquity of ecologists' focus on species.
-->
...
The field of ecology and conservation has experienced rapid growth since the discipline-specific journal, *Ecology*, was first published over a century ago [@reiners2017; @kim2018].
...
The decline in these historically popular terms may partly reflect trends in agricultural and soil scientists increasingly publishing in discipline-specific journals outside our corpus.
...
As an adjective, *ecosystem service* and *ecosystem function* were the dominant 2-grams (Fig. \@ref(fig:blanks)j), with the former showing a rapid increase after the United Nations' Milleneum Ecosystem Assessment championed the concept as a fundamental principle in the early 2000s [@mea2005].
...
<!-- TODO: change this topic sentence to match the new panels: -->
...
We found no dominant hypothesis but a number of changing patterns around the hypotheses largely predicting biodiversity.
...
By 2010, *phylogenetic* was the fourth most common adjective associated with *analysis* (Fig. \@ref(fig:blanks)l) and the third most common associated with *hypothesis* (Fig. \@ref(fig:ecology)e).
...
In terms of genetics tools, *microsatellites* and *mtDNA* were the most commonly referenced terms as of 2010, but *next-generation sequencing* nearly overtook *microsatellites* and may have done so by now.
...
<!-- n = 62 -->
This step reduced the corpus from approximately one billion words to just over 0.5 billion words, although the patterns in the "hand-curated panels" (Fig. \@ref(fig:cons)--\@ref(fig:social)) remained largely unchanged.
(2) We removed all journals that were not in English.
<!-- n = 18 -->
(3) We removed all journals that were not focussed on ecology or conservation (e.g., we removed journals that were purely biology focused).
<!-- n = 98 -->
...
This focussed our corpus on long-standing journals and reduce the influence of journals appearing and disappearing from the corpus and thereby influencing trends.
(5) We removed journals that were region specific.
<!-- n = 24 -->
Specifically, we removed journals that were specific with respect to longitude but retained journals that were latitude specific (e.g., we retained "Arctic and Alpine Research" but not "Great Basin Naturalist Memoirs").
...
We then removed all n-grams that included numbers, we removed all 1-grams that had three or fewer characters, and we removed 2-grams in which either the first or second term had three or fewer characters.
