...
The focus on genetics in ecology and conversation-related research has skyrocketed in the last several decades (*genetic diversity* in Fig. \@ref(fig:blanks)f, Fig. \@ref(fig:methods)ef). 
...
*Microsatellites* and *mtDNA* remain the most commonly referenced genetic tools, with microsatellites skyrocketing in use since the mid-1990s. With the advent of *next-generation sequencing* [@sanger1977], we have also seen an increase in sequencing-based approaches to studying genetic diversity, particularly the rise in references to *single nucleotide polymorphisms* (Fig. \@ref(fig:methods)f). Since 2010, when our data set ends, there has likely been an increase in references to *next-generation sequencing* given that it is rapidly being adopted in ecological research of many species---not just model species.
...
The full-text corpus is available through consultation with the JSTOR data team (<https://jstor.org)>. All code to conduct our analysis and some derived data sets available at <https://github.com/seananderson/ecology-trends> and *Zenodo DOI goes here on publication*.
