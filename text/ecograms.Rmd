...
<!-- FIXME: we need to rearrange this  to match the new ordering of the panels (assuming the ordering of the panels is what we decided on) -->
...
Yet references to *abundance* plateaued in the 2000s while references to *diversity*, which incorporates both *abundance* and *richness*, have become the most common since the mid 1990s (Fig. \@ref(fig:ecology)c).
The theory of the *climax community* climaxed in the 1940s, and community structure and populations next peak occurred in the 1960s with the *theory of island biogeography* (REF), followed by an interest in *foraging theory*, and a peak and dropoff in *neutral theory* (REF) (Fig. \@ref(fig:ecology)d).
The *theory of natural selection* and the role of evolution in ecology has been a constant theme (Fig. \@ref(fig:ecology)d).
<!-- FIXME: adjust this next sentence now that the null hypothesis is no longer included -->
In ecology, the *null hypothesis* reigns, with a meteoric rise in the 1970s, replacing the frequently mentioned *hormone hypothesis* (REF) in the 1930s--50s.
