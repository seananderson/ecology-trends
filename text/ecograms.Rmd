...
The fields of ecology and conservation have experienced rapid growth since the discipline-specific journal, *Ecology*, was first published over a century ago [@reiners2017; @kim2018].
...
<!-- n = 62 -->
This step reduced the corpus from approximately one billion words to just over 0.5 billion words, although the patterns in the "curated panels" (Fig. \@ref(fig:ecology)--\@ref(fig:social)) remained largely unchanged with the inclusion of taxonomically specific journals (not shown).
