...
date: |
  ...
  ^7^Departments of Biology and Environmental Studies, St. Olaf College, Northfield, MN 55057, USA\
...
Popular data-related terms in the modern era included *data*, *effect*, and *model* (Fig. \@ref(fig:decades)c).
...
<!-- n = 62 -->
This step reduced the corpus from approximately one billion words to just over 0.5 billion words, although the patterns in the "curated panels" (Fig. \@ref(fig:ecology)--\@ref(fig:social)) remained largely unchanged with the inclusion of taxonomically specific journals.
...
<!-- n = 98 -->
(4) We removed journals that appeared in the JSTOR database for less than 10 years unless they were still in the database as of 2010 or continued under a different name (e.g., TODO and TODO).
<!-- TODO: add example -->
...
Caption is the same as for Fig. \@ref(fig:ecology).
