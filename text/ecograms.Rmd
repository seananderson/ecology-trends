...
Interestingly, the most commonly represented theories in ecology appear to all be in declining use (Fig. \@ref(fig:ecology)d). Specifically, the theory of the *climax community* climaxed in the 1940s, and community structure and populations next peak occurred in the 1960s with the *theory of island biogeography* (REF), followed by an interest in *foraging theory*, and a peak and dropoff in *neutral theory* (REF) (Fig. \@ref(fig:ecology)d).
Though there is not direct evidence of most common theories following the most common hypothesis, the decline in the mention of *competition* (Fig. \@ref(fig:ecology)c)is mirrored by the decline in interest in the competition hypothesis (Fig. \@ref(fig:ecology)e), which as terms in the corpus may be inextricably intertwined in this context. 
