...
Popular terms in the 1940s included *blue grama* (*Bouteloua gracilis*) and *wheat grass* (Fig. \@ref(fig:decades)b), which likely had greater significance during and after the Dust Browl drought experienced in the North American prairies in the 1930s [@mueller1942; @worster2004].
...
We found no dominant hypothesis but a number of changing patterns around the hypotheses predicting biodiversity.
...
By 2010, *phylogenetic* was the fourth most common adjective associated with *analysis* (Fig. \@ref(fig:blanks)l) and the third most common associated with *analysis* (Fig. \@ref(fig:ecology)e).
...
We thank the David H. Smith Conservation Research Fellowship, which supported all of the authors financially at some point while completing this project.
We thank
M.P. Dombeck,
S.G. Foster,
T. Chang,
...
and
T. Young
for their support and helpful discussions about this project.
