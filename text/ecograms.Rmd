...
In fact, by 2010, "phylogenetic analysis" was the fourth most commonly used "____ analysis" 2-gram (Fig. \@ref(fig:blanks)l) and "phylogenetic hypothesis" was the third highest "____ hypothesis" 2-gram (Fig. \@ref(fig:ecology)e).
The 1980s was when we really began to see a strong interest in genetic variation and diversity in the ecological literature, with the terms *genetic variation*, *gene flow*, and *evolutionary biology* all appearing in the top 144 2-grams for the years 1980--1999 (Fig. \@ref(fig:giant-2-1980)) and  *genetic diversity* showing up in the 2000--2010 range (Fig. \@ref(fig:giant-2-2000)).
In terms of genetic tools, *microsatellites* and *mtDNA* were the most commonly referenced terms as of 2010, but *next-generation sequencing* nearly overtook *microsatellites* and may have done so by now.
