...
<!-- SK: 
The field of ecology has experienced rapid growth since the discipline-specific journal, *Ecology*, was first published over a century ago [@reiners2017; @kim2018]. Today, hundreds of ecology journals represent numerous subdisciplines span in scope from theoretical to applied. It is potentially no suprise that the field is today had diverged into many distinct subdisciplines; although there is much disagreement about the origins and emergence of ecology as its own unique scientific discipline, most scholars  agree that "ecology" arose at some point in the late 19th or early 20th century drawing from a broad selection of academic studies including geography, geology, evolutionary biology, systematics, physiology, natural history, and natural resource management (@Simberloff 1980; @Edgerton1983; @Kingsland 2005, @Ayres2012, @Huston2016).

Some of the fastest growing subdisciplines in ecology fall under the umbrella of "applied ecology" and focus on the conservation, protection, and management of rapidly diminishing natural resources, ecosystems, and plant and animal populations (@Staples2019; @Li2011; @Lockwood2013; @Griffiths2012). This is likely owing to the mounting evidence of the scale and magnitude of the impact of human populations on global biogeochemical cycles, species extinction rates, and habitat conversion (@Staples2019; @Li2011; @Lockwood2013; @Griffiths2012; @Young2005; @Simberloff 2011). A danger for any rapidly growing field of study is that researchers can quickly become "siloed" into thier own subdiscipline camps, forming their own jargon, missing key conceptual bridges, and squandering potential opportunities for interdiscplinary collaborations (@Staples2019; @Margles2010).  This academic path is especially worrisome for applied ecological research because of the urgency for scientifically-sound data to inform conservation and management decisions (cite IPBES summary report and latest IPCC report). 

In light of such rapid growth and diversification, synthesizing larger trends in a field can be challenging. Yet, broad overviews can be critical for bridging siloed disciplines and highlighting key concepts that potentially span mutliple subdisciplines. Additionally, syntheses can guide new research, inform funding directions, and structure educational frameworks [@mccallen2019]. The discipline of culturomics---the quantitative analysis of large bodies of text---offers a rich framework with which to track the evolution of a field through time [@michel2011; @ladle2016] and highlight areas of convergence across subdiciplines. Specifically, word use in the published literature can serve as a proxy for tracking realized, versus perceived, importance of fundamental concepts and terms. This approach has been successfully applied to smaller subsets of the ecological literature, notably a century of titles and abstracts in the journal *Ecology* [@kim2018], automated content analysis of titles and abstracts in top ecology journals based on impact factor [@mccallen2019], and more specific research questions restricted to certain regions or taxa [e.g., @beale2018, @Correia2018].
-->
