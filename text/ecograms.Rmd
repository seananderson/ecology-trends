...
We compared the trends in the most commonly used terms from the 1940s and the 2000s using 1-grams and 2-grams (Fig. \@ref(fig:decades)a-d). 
We found that the most commonly used word (1-grams) in ecology is "species" and that has not changed over the last century (Fig. \@ref(fig:decades)a&c), and is still a word that continues to increase in use. 
...
This reflects the recognized role humans play in earth's ecosystem processes in the last few decades as concern over climate change has increased, along with the need for conservation science (Fig. \@ref(fig:decades)e). 
Other terms also standout because of their conservation implications, such as *conservation*, *impact*, *biodiversity*, *ecosystem service*, *invasive species*, and *global ecology* (Fig. \@ref(fig:decades)e&f).

The changes we observed between popular terms from the 1940s and 2000s, likely relfect both a shift in science culture and are reflected in greater societal issues facing earth. 
In the 1940s popular terms, such as *time*, *number* and *day* (Fig. \@ref(fig:decades)a), reference descriptive data, probably more common before statistics and modelling became standard tools in ecological research. 
Similar terms that could represent time, day, and number are *data*, *effect*, *population*, and *model* (Fig. \@ref(fig:decades)b), which likely represents both replacement in terminology and a change in the field of ecology from a semi-quanitative to quantitiative discipline. 
Popular terms from the 1940s included *blue grama* and *wheatgrass* (Fig. \@ref(fig:decades)c), terms that could be considered rare today were important in the 1940s, likely due to famine in United State in the 1930s and World War II in the 1940s. 
Blue grama (*Bouteloua gracilis*) was heavily studied in the 1930s due to its drought tolerance (CITATION), whereas wheat grass research was likely intensified in the 1940s to feed troops fighting in World War II (CTIATION). 
...
<!-- reorder into:
scale,
scale without species
species interactions
theories
drop the plain hypotheses and drop the null hypothesis title
metrics
-->
...
We started by filtering the full data set down to the top 5000...
...
We excluded a set of 2-grams that would primarily be used as affiliations or journal names or were frequent figures of speech unrelated to ecology (e.g., "much more"): `r exclude`.

- Take top 500 for 2-grams
- Remove the following 1-grams

```{r}
c("fig", "use", "doi", "case", "tion", "cent", "while", "results", "table", "figure")
```
