...
The field of ecology has evolved over the past eight decades from a discipline that shared much of its core concepts with biology and focused prominently on fundamental science to one that is increasingly multidisciplinary and strongly emphasises applied research. Our results, based on the first ever full-text analysis of ecology and conservation journals, are in line with recent studies analysing trends in ecological concepts over four to ten decades derived from titles, abstracts, and keywords from published ecological literature [@kim2018; @mccallen2019], yet contrast markedly with findings from a recent review of expert opinions on trends in important ecological concepts [@reiners2017]. This discrepancy highlights that ecology may still largely be perceived as a discipline primarily concerned with topics of fundamental science, yet quantitative analyses that more exhaustively investigate trends reveal this perception may be misguided. However, our results reinform the notion of both previous quantitative studies [@mccallen2019] and expert opinion [@reiners2017] that ecologists are now working on increasingly complex and specialised topics, at broader spatial scales (ADD REF Estes et al. 2018 Nat Ecol Evol), and at higher levels of taxonomic and hierarchical organization [@kim2018]. Such advances have, in many cases, led to rapid advancement of concept formation, with many concepts originating since 2000.

Our results also highlight that the analytical techniques used in ecology have evolved along with concept formation, with ecological research becoming increasingly quantitative and data-driven (Fig. \@ref(fig:methods-all)). In particular, a multitude of statistical paradigms and analytical techniques in genetics have emerged in the ecological literature over the past three decades, despite being readily applied in other disciplines, such as computer science and engineering (REF?). This suggests that advanced training in statistics, evolutionary techniques, and computer programming may be increasingly important in ecological curricula.  

While results from our full-text analysis from ecological journals were largely consistent with those from titles, abstracts, and keywords [@mccallen2019], we also uncovered some important differences in trends. Notably, McCallen et al. (2019)[@mccallen2019] found a slight decrease in the use of *conservation* in their analysis, while our full-text analysis revealed that *conservation* was one of the fastest growing terms in our corpus (Fig. \@ref(fig:cons)a). This may be due to higher frequency of use of the term in the introduction or discussion sections of a manuscript, which appear in much-abbreviated forms in abstracts, yet we cannot test this directly with our approach. Similarly, McCallen et al. (2019)[@mccallen2019] found a signficant decline in the use of *competition* over the past four decades. Indeed, between 1970-2010, the frequency of *competition* mainly declined in our analysis, yet when analysed over eight decades, we found that the underlying trend is modal and with an overall positive slope (Fig. \@ref(fig:ecology)c). We caution that trends can be sensitive to the temporal scale considered. 
