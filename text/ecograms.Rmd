...
Our analysis gives ecologists a chance to reflect on where the field has come from and where it is are going. Eight decades has seen an evolution from a natural-history and fundamental-science field to a multidisciplinary, applied, and quantitative field. Undoubtedly, the fields of ecology and conservation have and will continue to adopt approaches developed elsewhere such as analyses of "big" datasets and artificial intelligence, which will empower ecologists to answer questions that were previously unanswerable [REF]. And while quantitative meta-analysis-style research---this paper included---can undoubtedly be valuable, if ecology wishes to maintain its natural-history and fundamental-science roots, the field needs to prioritize such a focus through research funding bodies and educational curricula [REF?]. Ecology today is almost unrecognizable from the field 90 years ago; only time will tell if that pace of evolution will continue, leaving ecologists in 2100 with similar thoughts.



<!-- Our approach underscores the value of data sets such as the JSTOR n-gram data, and similar analyses are likely to become even more fruitful going forward with the increasing popularity of ecological preprint libraries [REF], open access publication [REF], and on-line publishing as a first class citizen [REF].
 -->
