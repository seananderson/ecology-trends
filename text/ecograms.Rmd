...
"The Wilson Journal of Ornithology"). (2) We removed all journals that were not in
English. We removed all journals that were not relevant to ecology or
...
were too region specific. Specifically, be removed to journals that were
...
Memoirs"). In total, our corpus included TODO journals (Figure TODO).
...
limited set of journals included in the corpus and after 2010, the JSTOR corpus
did not yet have data for all journals present in 2010 --- the number of
journals present and the total number of words began to decline (Fig. TODO).
...
were frequent figures of speech unrelated to ecology (Table TODO).
...
where $y_i$ refers to the number of occurrences of a give n-gram in year $i$,
...
journals %>%
  ...
  arrange(`Inclusion code`, Journal) %>% 
  ...
  kableExtra::column_spec(column = 1, width = "4.0in") %>% 
  kableExtra::column_spec(column = 2, width = "0.7in") %>% 
  kableExtra::column_spec(column = 3, width = "1.5in")
```
