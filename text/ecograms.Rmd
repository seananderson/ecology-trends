...
This approach has been applied to smaller subsets of the ecological literature, notably a century of titles and abstracts in the journal *Ecology* [@kim2018], automated content analysis of titles and abstracts in top ecology journals based on impact factor [e.g., @mccallen2019], and specific research questions for certain regions or taxa [e.g., @beale2018].
...
By far, the 1- and 2-grams with the greatest rise in use over time were *climate* and *climate change* (Fig. \@ref(fig:decades)d--f), as the ecological effects of climate change impacted study systems and overshadowed other drivers [e.g., @li2011; @scheffers2016; @staples2019].
...
As an adjective, *ecosystem service* and *ecosystem function* were the dominant 2-grams (Fig. \@ref(fig:blanks)j), with the former showing a rapid increase after the United Nations' Millennium Ecosystem Assessment championed the concept as a fundamental principle in the early 2000s [@mea2005].
...
It is perhaps unsurprising that *ecosystem* was the least common term given that it is also the youngest scale: while the term *ecosystem* was first described in 1935 by @tansley1935, ecosystem ecology was not formalized until @odum1953.
...
Historically, *hunting* and *fishing* exchanged positions of dominance every decade, showing predator-prey-like dynamics in their frequency over time (Fig. \@ref(fig:cons)e).
...
In terms of genetics tools, *microsatellites* and *mtDNA* (mitochondrial DNA) were the most commonly referenced terms as of 2010, but *next-generation sequencing* nearly overtook *microsatellites* and may have done so since 2010.
...
The turnover in ecological terminology demonstrates how ecologists have embraced many newly coined terms such as *biodiversity*, *climate change*, and *meta-analysis*, which did not exist in the early decades of the field, and signifies the evolution of ecology into a fully independent field of study.
Our results, reinforce the notion of both previous quantitative- [@kim2018; @mccallen2019; @hintzen2019] and expert-opinion-based studies [@reiners2017] that ecologists are working on increasingly complex and specialized topics, at broader spatial scales [@estes2018], and at higher levels of taxonomic and hierarchical organization [@kim2018].
