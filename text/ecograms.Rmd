...
<!-- n = 62 -->
This step reduced the corpus from approximately one billion words to just over 0.5 billion words, although the patterns in the "hand-curated panels" (Fig. \@ref(fig:ecology)--\@ref(fig:social)) remained largely unchanged.
