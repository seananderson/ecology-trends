...
There is generally agreement that the field of ecology arose in the late 19th or early 20th century drawing from a broad set of disciplines including geography, geology, evolutionary biology, systematics, physiology, natural history, and natural resource management [@simberloff1980; @egerton1983; @kingsland2005; @ayres2012; @huston2016].
Today, there are hundreds of ecology journals representing subdisciplines spanning in scope from theoretical to applied, and in scale from ecosystems to genomes (CITE).



In any rapidly growing field of study, one potential danger is that researchers can become "siloed" in their own subdisciplines, i.e., forming their own jargon and potentially missing conceptual bridges or opportunities for interdisciplinary collaborations [@staples2019; @margles2010]. 


For example, some of the fastest growing subdisciplines in ecology fall under the umbrella of "applied ecology" and focus on the conservation, protection, and management of natural resources, ecosystems, and plant and animal populations [@staples2019; @li2011; @lockwood2013; @griffiths2012].
The subdiscipline is represented by XXX targeted journals with researchers from public and private institutions, non-profits and government agencies working... 
To read all articles published each month from these journals would take XXX hours to complete!
...
Here, we build on previous analyses [e.g., @carmel2013; @reiners2017; @kim2018; @mccallen2019] by providing the first full-text analysis of ecology journals over eight decades encompassing `r n_journals` journals, 131,533 articles, including over half a billion words.
