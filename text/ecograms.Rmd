...
\@ref(fig:methods)e). Interestingly, phylogenetics has remained the most common
referenced genetic term over the years, at a rapidly increasing rate since the
1990s (Fig. \@ref(fig:methods)e). With the advent of next-generation
sequencing, we also see a fast increase in sequencing based approaches to
studying genetic diversity, particularly the rise in reference to *single
nucleotide polymorphisms* (Fig. \@ref(fig:methods)f). Interestingly, the term
*epigenetics* has been in use since the 1950s (See Supplementary figure),
before we had methods for studying epigenetics in the modern sense [@bird2007].
This is likely due to the fact that beginning the 1940s, the term *epigenetics*
was used to refer to the differentiation of cells during embryonic development
[@waddington2012]. The term also has been used in developmental psychology
[@gottlieb1991].
