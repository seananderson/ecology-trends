...
Ecology does not lack reflections on the state of the field [REFs]; 
...
Here, we build on previous analyses [e.g., @carmel2013; @reiners2017; @kim2018; @mccallen2019] with the first full-text analysis of ecology journals over eight decades encompassing `r n_journals` journals, 131,533 articles, and over half a billion words.
